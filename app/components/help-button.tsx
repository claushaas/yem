		...
		<Dialog.Root>
			...
			<Dialog.Portal>
				...
				<Dialog.Content className="fixed bottom-5 right-5 w-72 p-6 bg-mauve-2 dark:bg-mauvedark-2 z-50 rounded-xl">
					...
					<div>
						<p className="mb-4">
							Caso precise de ajuda, entre em contato conosco em um de nossos
							canais de suporte, nos links abaixo:
						</p>
						<div className="flex justify-between gap-4">
							<button
								className="basis-1/2 bg-mauve-5 p-3 dark:bg-mauvedark-5 rounded-xl"
								type="button"
							>
								<a
									href="https://t.me/yogaemmovimento_bot"
									rel="noreferrer"
									target="_blank"
								>
									<p>Telegram</p>
