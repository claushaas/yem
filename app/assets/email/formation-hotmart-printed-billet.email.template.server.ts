...
export const formationHotmartPrintedBilletEmailTemplate = (firstName: string, to: string, linkBoleto: string, codigoDoBoleto: string): TEmailTemplate => ({
	to,
...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px;">Olá, ${firstName}, foi emitido um boleto para pagamento de uma parcela da Formação em Yoga.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Código de barras para pagamento: ${codigoDoBoleto}</p>
																	<p style="margin: 0; margin-bottom: 16px;">Link para imprimir o boleto: <a href="${linkBoleto}" target="_blank" style="text-decoration: underline; color: #7747FF;" rel="noopener">${linkBoleto}</a></p>
  ...
  `,
	text: `
  Olá, ${firstName}, foi emitido um boleto para pagamento de uma parcela da Formação em Yoga.

	Código de barras para pagamento: ${codigoDoBoleto}

	Link para imprimir o boleto: ${linkBoleto}
