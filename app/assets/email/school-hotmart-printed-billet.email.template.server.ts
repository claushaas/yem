...
export const schoolHotmartPrintedBilletEmailTemplate = (firstName: string, to: string, linkBoleto: string, codigoDoBoleto: string): TEmailTemplate => ({
	to,
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px;">Olá, ${firstName}, foi emitido um boleto para pagamento da sua mensalidade da Escola Yoga em Movimento.</p>
