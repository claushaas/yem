...
export const formationHotmartPrintedPixEmailTemplate = (firstName: string, to: string, linkDoPix: string): TEmailTemplate => ({
	to,
...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px;">Olá, ${firstName}, foi emitido um código PIX para pagamento de uma parcela da Formação em Yoga.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Acesse o código e o qrcode do PIX: <a href="${linkDoPix}" target="_blank" style="text-decoration: underline; color: #7747FF;" rel="noopener">${linkDoPix}</a></p>
  ...
  `,
	text: `
  Olá, ${firstName}, foi emitido um código PIX para pagamento de uma parcela da Formação em Yoga.

	Acesse o código e o qrcode do PIX: ${linkDoPix}
