...
export const formationHotmartDelayedBilletEmailTemplate = (firstName: string, to: string): TEmailTemplate => ({
	to,
...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">A Hotmart não recebeu a confirmação do pagamento do boleto relativo a sua última parcela da Formação em Yoga do Yoga em Movimento.</p>
  ...
  Olá, ${firstName}, tudo bem contigo?
	...
	A Hotmart não recebeu a confirmação do pagamento do boleto relativo a sua última parcela da Formação em Yoga do Yoga em Movimento.
