...
export const formationHotmartFailedCreditCardEmailTemplate = (firstName: string, to: string, descricaoDoErro: string): TEmailTemplate => ({
	to,
...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">Foi feita a tentativa de cobrança de uma parcela da Formação em Yoga no seu cartão, mas houve uma falha na cobrança.</p>
																	<p style="margin: 0; margin-bottom: 16px;">A Hotmart informou o seguinte erro ao tentar fazer a cobrança: ${descricaoDoErro}.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Acesse <a href="https://consumer.hotmart.com/purchase/1392822" target="_blank" style="text-decoration: underline; color: #7747FF;" rel="noopener">https://consumer.hotmart.com/purchase/135340</a> com o email usado em nosso site (${to}) para regularizar o pagamento e não perder o acesso ao conteúdo.</p>
  ...
  Olá, ${firstName}, tudo bem contigo?
	...
	Foi feita a tentativa de cobrança de uma parcela da Formação em Yoga no seu cartão, mas houve uma falha na cobrança.
