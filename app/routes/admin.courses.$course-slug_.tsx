...
import {
	data, Form, useLoaderData, useNavigation, useParams, type MetaArgs, type ActionFunctionArgs, type LoaderFunctionArgs,
} from 'react-router';
			...
			<div>
				...
				{course.content && (
					<>
						...
						<ContentConverter content={course.content} className='p-4 rounded-lg border-2 border-mauve-6 dark:border-mauvedark-6 max-w-(--breakpoint-lg)'/>
					</>
				)}
